...
public partial class Uploadfacultydetails : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert Into faculty(name,designation,department,image)values('" + name.Text + "','" + designation.Text + "','" + Department.Text + "',@y)", con);
